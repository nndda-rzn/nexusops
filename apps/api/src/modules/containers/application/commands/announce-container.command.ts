...
import { Container, isValidContainerNumber } from '@/modules/containers/domain/entities/container.entity'
...
export async function announceContainerCommand(
  ...
  return { id: container.id, containerNumber: container.containerNumber, status: container.status }
}
