...
import { listSlotsQuery } from '@/modules/yard/application/queries/yard.queries'
import { placeContainerCommand, moveContainerInYardCommand, removeContainerFromYardCommand, reserveSlotCommand } from '@/modules/yard/application/commands/yard.commands'
import { parsePaginationQuery } from '@/shared/pagination/query-helpers'

export const yardContainerRoutes = new Elysia({ prefix: '/yard' })
  .use(authMiddleware)
