...
// Warehouse
import type {
  WarehouseReceivedEvent, WarehousePutawayCompletedEvent,
  WarehousePickingStartedEvent, WarehouseDispatchedEvent,
  WarehouseInventoryAdjustedEvent, WarehouseCycleCountCompletedEvent,
} from '@/modules/warehouse/domain/events/warehouse.events'

// Inline event types (intermodal, shipments, containers, road position)
import type {
...
export type EventMap = {
  ...
  // Warehouse
  'warehouse.received': WarehouseReceivedEvent
  'warehouse.putaway_completed': WarehousePutawayCompletedEvent
  'warehouse.picking_started': WarehousePickingStartedEvent
  'warehouse.dispatched': WarehouseDispatchedEvent
  'warehouse.inventory_adjusted': WarehouseInventoryAdjustedEvent
  'warehouse.cycle_count_completed': WarehouseCycleCountCompletedEvent
}
